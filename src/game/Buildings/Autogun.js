define("game/Buildings/Autogun", ["game/Buildings/Building", "game/Settings", "game/Weapons"], function (Building, Settings, Weapons) {
    var canvas = document.createElement("canvas");
    var building = function (level, player, blockX, blockY) {
        Building.call(this, level, player, blockX, blockY);
        this.Health = 5;
        this.Weapon = new Weapons.Autogun(this);
