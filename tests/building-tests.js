describe('Building Tests', function () {
    ...
    beforeEach(function () {
        runs(function () {
            require(["game/Levels", "game/buildings/list", "../src/game/buildings/building", "game/Unit", "game/PlayerCommands"], function (levels, buildings, building, unit, playerCommands) {
                Levels = levels;
                Buildings = buildings;
                Building = building;
                Unit = unit;
